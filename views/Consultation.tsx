...
export default function Consultation() {
  ...
  const handleNext = async () => {
    ...
    try {
      ...
      // Filter treatments that match ANY of the selected categories
  ...
  return (
    <div className="min-h-screen bg-[#FDFBF7] flex flex-col p-8">
      ...
      {error && (
        <div className="max-w-md mx-auto mb-8 flex items-center gap-3 p-4 bg-red-50 text-red-700 rounded-xl border border-red-100 shadow-sm animate-fade-in">
          <AlertCircle size={20} />
          {error}
        </div>
      )}
